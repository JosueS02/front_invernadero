...
- [ ] T010 Configure backend base with Spring Boot 3 and Java 17
- [ ] T011 [P] Configure PostgreSQL connection, migrations, and local profile
- [ ] T012 [P] Enable and publish OpenAPI 3 / Swagger documentation
...
- [ ] T021 [US1] Update OpenAPI/Swagger contract for user story 1 endpoints
